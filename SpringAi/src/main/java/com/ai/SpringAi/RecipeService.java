...
public class RecipeService {
    ...
    public String createRecipe(String ingredients, String cuisine, String dietaryRestrictions) {
        var template = """
                Create a recipe using the following ingredients: {ingredients}. The recipe should be in the {cuisine} cuisine style and should consider the following dietary restrictions: {dietaryRestrictions}.
                """;
